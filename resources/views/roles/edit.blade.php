                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" name="permission[]" value="{{ $permission->id }}"
                                                ...
                                                @elseif(in_array($permission->id, $rolePermissions)) checked @endif>
                                        </td>
                                        <td>
                                            <input type="checkbox" name="add_permission[]" value="{{ $permission->id }}"
                                                @if(in_array($permission->id . '_add', $rolePermissions)) checked @endif>
                                        </td>
                                        <td>
                                            <input type="checkbox" name="edit_permission[]" value="{{ $permission->id }}"
                                                @if(in_array($permission->id . '_edit', $rolePermissions)) checked @endif>
                                        </td>
                                        <td>
                                            <input type="checkbox" name="delete_permission[]" value="{{ $permission->id }}"
                                                @if(in_array($permission->id . '_delete', $rolePermissions)) checked @endif>
                                        </td>
                                        <td>
                                            <input type="checkbox" name="show_permission[]" value="{{ $permission->id }}"
                                                @if(in_array($permission->id . '_view', $rolePermissions)) checked @endif>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
