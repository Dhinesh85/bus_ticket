<x-app-layout>
    ...
    <div class="py-8">
        <a href="{{ route('users.index') }}" class="inline-flex items-center px-4 py-2 mb-4 text-xs font-semibold tracking-widest text-black uppercase transition duration-150 ease-in-out bg-green-600 border border-transparent rounded-md hover:bg-green-500 active:bg-green-700 focus:outline-none focus:border-green-700 focus:shadow-outline-gray disabled:opacity-25" style="color: white;">
            <button class="inline-flex items-center px-4 py-2 my-3 text-xs font-semibold tracking-widest text-white uppercase transition duration-150 ease-in-out bg-gray-800 border border-transparent rounded-md hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25" style="margin-left: 60px;">
                Go back
            </button>
        </a>
                ...
                <div style="background-color: transparent; border: 3px solid wheat; border-radius: 20px; max-width: 100%; width: 30%; margin-right: inherit;margin-left: 75px;">
                    <div title="back" class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4" style="background-color: transparent;">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="w-full px-3 py-2 leading-tight border rounded shadow appearance-none focus:outline-none focus:shadow-outline" name="name" placeholder="Enter name" name="name" placeholder="Enter name" value="{{ old('name', $user->name) }}" required style="background-color: transparent; border: 2px solid white; border-radius: 11px; color: white;">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="w-full px-3 py-2 leading-tight border rounded shadow appearance-none focus:outline-none focus:shadow-outline" name="email" placeholder="Enter email" value="{{ old('email', $user->email) }}" required style="background-color: transparent; border: 2px solid white; border-radius: 11px; color: white;">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="address" id="address" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" style="background-color: transparent; border: 2px solid white; border-radius: 11px; color: white;"> {{ old('address', $user->address) }}</textarea>
                    ...
                    <div title="back" class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4" style="background-color: transparent;">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="role_id"
                                ...
                                required>
                                <option disabled {{ old('role_id', $user->userrole->id ?? '') == '' ? 'selected' : '' }}>Choose a role</option>

                                @foreach ($roles as $role)
                                <option value="{{ $role->id }}"
                                    {{ old('role_id', $user->userrole->id ?? '') == $role->id ? 'selected' : '' }}>
                                    {{ $role->name }}
                                </option>
                                @endforeach
                            </select>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Set today's date for start date minimum
            ...
            startDateInput.addEventListener('change', function() {
                ...
                if (endDateInput.value < minEnd || endDateInput.value > maxEnd) {
                    endDateInput.value = '';
                }
            ...
            // Location and payment calculations
